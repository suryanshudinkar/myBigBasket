    ...
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
		...
		<main class="px-3">
			...
			<div class="mb-3">
				...
				<div id="emailHelp" class="form-text">We'll never share your
					username & password with anyone else.</div>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3 form-check">
				...
				<label class="form-check-label" for="exampleCheck1">I am not
					a robot</label>
			</div>
		...
		<form action="allUsers" method="post">
				<input type="submit" value="Show all users" class="btn btn-outline-primary" />
				<br>
			</form>
		</main>

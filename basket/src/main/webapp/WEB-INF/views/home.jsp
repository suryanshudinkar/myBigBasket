    ...
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
		...
		<main class="px-3">
			...
			<p class="lead">India’s largest online food and grocery store. At
				bigbasket.com we believe in being smart, quick and efficient, making
				your life as leisurely as possible.</p>
